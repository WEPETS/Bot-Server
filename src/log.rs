use crate::routes::rpc::RpcInfo;
use crate::routes::Error;
use crate::Result;
use crate::{ctx::Ctx, routes::ClientError};
...
pub async fn log_request(
    ...
    let error_type = route_error.map(|se| se.as_ref().to_string());
    let error_data = serde_json::to_value(route_error)
        .ok()
