...
pub fn from_unix_timestamp(timestamp: i64) -> Result<OffsetDateTime> {
    OffsetDateTime::from_unix_timestamp(timestamp).map_err(|_| Error::FailToTimestampParse)
}
